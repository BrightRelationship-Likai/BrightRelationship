...
class CsSqlRestart(CsDataBag):
    ...
    def __update(self, vm_ip, password):
        proc = CsProcess(['/opt/cloud/bin/chsqlrestart.py', vm_ip])
class CsSqlPort(CsDataBag):
...
class CsRemoteAccessVpn(CsDataBag):
    ...
    def configure_l2tpIpsec(self, left,  obj):
        ...
        # xrstack - Clean up first to avoid useless PSK that used before
        secret.empty()
